...
static int
t_gss_channel_bindings_check(gss_name_t target_name, OM_uint32 req_flags,
                             ...
                             OM_uint32 e_accept_ret_flags)
{
    ...
    OM_uint32 init_maj_stat = 0;
    OM_uint32 accept_maj_stat = 0;
    ...
    do {
        init_maj_stat = gss_init_sec_context(&min_stat, GSS_C_NO_CREDENTIAL,
                                             &init_context, target_name, mech,
                                             0, 0, cbindings, GSS_C_NO_BUFFER,
                                             NULL, &init_token,
                                             &init_ret_flags, NULL);
        ...
        accept_maj_stat = gss_accept_sec_context(&min_stat, &accept_context,
                                                 cred, &init_token,
                                                 cbindings, NULL, NULL,
                                                 &accept_token,
